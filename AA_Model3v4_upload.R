...
data <- data["",]							## you may need to subset your data
...
rr <- 0.09379166				## define the fixed rate of antibody decay
...
prior_M3 = function( par_M3 )
{
	...
	prior = prior_alpha_0 + prior_gamma +  prior_sigma + prior_alpha_STI
...
colnames(MCMC_par) = c("alpha_0", "gamma", "sigma", "alpha_STI", "loglike", "prior")
...
par_MC = c(10, 0.2, 0.6, 10)       ## (alpha_0, gamma, sigma, alpha_STI)
